...
int main(void) {
  ...
  Suite *s21_string_test[] = {test_memchr(),           test_memcmp(),
                              ...
                              test_sprintf_n(),        test_sprintf_unsigned(),
                              test_sprintf_HEX(),      test_sprintf_hex(),
                              test_sprintf_pointer(),  test_sprintf_signed(),
                              test_sprintf_signed_i(), test_to_upper(),
                              test_insert(),           test_trim(),
                              test_to_lower(),         test_sprintf_string(),
                              test_sscanf_empty(),     test_sscanf_c(),
                              test_sscanf_d(),         test_sscanf_pr(),
                              test_sscanf_n(),         test_sprintf_e(),
                              test_sprintf_g(),        NULL};
